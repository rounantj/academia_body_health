...
namespace EasyInnerSDK.Entity
{
    public class OnUpdateDisplay
    {
        ...
        public bool HabCartaoMaster { get; set; }
        ...
        public void AtualizarBilheteOnline(Bilhete RegistroOnline)
        {
            ...
            uiOnline.lstBilhetes.SetSelected(uiOnline.lstBilhetes.Items.Count - 1, true);
            uiOnline.lstBilhetes.ClearSelected();
        }
        ...
        public void AtualizarVersaoInner(Inner InnerAtual)
        {
            ...
            {
                Console.WriteLine(uiOnline.lstVersaoInners.Items[index].ToString());
                Console.WriteLine((uiOnline.lstVersaoInners.Items[index].ToString().Substring(7, 1)));
            ...
            if (Encontrado == false)
            {
                uiOnline.lstVersaoInners.Items.Add("Inner: " + InnerAtual.Numero + 
                                                    " | " + InnerAtual.LinhaInner + ": " + InnerAtual.VersaoInner +
                                                    //" | " + (InnerAtual.Biometrico ? (InnerAtual.TipoComBio == 0 ? "Bio LN" : "Bio LC") : "Sem bio") +
        ...
        public bool getInfoInner()
        {
            ...
            HabCartaoMaster = uiOnline.chkCartaoMaster.Checked;
            return true;
        }
