...
namespace EasyInnerSDK.Entity
{
    public class Enumeradores
    {
        ...
        public enum TipoLeitor
        {
            ...
            WIEGAND = 3,
            PROXIMIDADE_SMART_CARD_SERIAL = 4,
            CODIGO_BARRAS_SERIAL = 5,
            WIEGAND_FC_SEM_SEPARADOR = 6,
            WIEGAND_FC_COM_SEPARADOR = 7,
            QRCODE_LETRAS = 8,
            BARRAS_PROX_QRCODE = 7
        }
        #endregion
        ...
        { 
            ...
            RET_BIO_TEMPLATE_INVALIDO = 136,
            RET_BIO_PARAMETRO_INVALIDO = 137,
            RET_BIO_MODULO_INCORRETO = 250
        }
        #endregion
        ...
        public enum Retorno
        {
            ...
            RET_BIO_USR_NAO_CADASTRADO  = 132,
            RET_BIO_BASE_CHEIA          = 133,
            RET_BIO_DIG_NAO_CONFERE     = 134,
            RET_BIO_INVALIDA            = 135,
            RET_BIO_TEMPLATE_INVALIDO   = 136,
            RET_BIO_PARAMETRO_INVALIDO  = 137
