...
namespace EasyInnerSDK.UI
{
    public class FrmOnlineController
    {
        ...
        public void AdicionarInner()
        {
            ...
            objInner.Catraca = true;// UpdateDisplay.Acionamento != (byte)Enumeradores.Acionamento.Acionamento_Coletor;
        //    Console.WriteLine("Catraca ->" objInner.Catraca);
            ...
            objInner.Numero = 1;//UpdateDisplay.NumInner;
            Console.WriteLine(UpdateDisplay.NumInner);

            objInner.QtdDigitos = 14;// UpdateDisplay.QtdDigitos;
            Console.WriteLine(UpdateDisplay.QtdDigitos);

            objInner.Teclado = true;// UpdateDisplay.Teclado;
            Console.WriteLine(UpdateDisplay.Teclado);

            objInner.Lista = true;//UpdateDisplay.ListaOff;
            Console.WriteLine(UpdateDisplay.ListaOff);

            objInner.ListaBioSemDigital = true;//UpdateDisplay.ListaSemDigital;
            Console.WriteLine(UpdateDisplay.ListaSemDigital);

            objInner.TipoLeitor = 2;// UpdateDisplay.TipoLeitor;
            Console.WriteLine(UpdateDisplay.TipoConexao);

            objInner.Identificacao = 1;// (byte)(UpdateDisplay.Identificacao ? Enumeradores.Opcao.SIM : Enumeradores.Opcao.NAO);
            Console.WriteLine((byte)(UpdateDisplay.Identificacao ? Enumeradores.Opcao.SIM : Enumeradores.Opcao.NAO));

            objInner.Verificacao = 1;// (byte)(UpdateDisplay.Verificacao ? Enumeradores.Opcao.SIM : Enumeradores.Opcao.NAO);
            Console.WriteLine((byte)(UpdateDisplay.Verificacao ? Enumeradores.Opcao.SIM : Enumeradores.Opcao.NAO));

            objInner.DoisLeitores = false;// UpdateDisplay.DoisLeitores;
            Console.WriteLine(UpdateDisplay.DoisLeitores);

            objInner.VariacaoInner = 0;
            Console.WriteLine(0);

            objInner.Acionamento = 1;// UpdateDisplay.Acionamento;
            Console.WriteLine(UpdateDisplay.Acionamento);

            objInner.CatInvertida = false;// UpdateDisplay.CatInvertida;
            Console.WriteLine(UpdateDisplay.CatInvertida);

            objInner.PadraoCartao = 1;// UpdateDisplay.PadraoCartao;
            Console.WriteLine(UpdateDisplay.PadraoCartao);

            objInner.TipoConexao = 2;// UpdateDisplay.TipoConexao;
            Console.WriteLine(UpdateDisplay.TipoConexao);

            objInner.Porta = 3570;// UpdateDisplay.Porta;
            Console.WriteLine(UpdateDisplay.Porta);

            objInner.TipoComBio = 1;// UpdateDisplay.ModuloBio;
            Console.WriteLine(UpdateDisplay.ModuloBio);

            objInner.CartMaster = false;// UpdateDisplay.HabCartaoMaster;
            Console.WriteLine(UpdateDisplay.HabCartaoMaster);

            objInner.Master = UpdateDisplay.CartaoMaster;
            Console.WriteLine(UpdateDisplay.CartaoMaster);
         ...
         //   MessageBox.Show(objInner.ToString());
        ...
        public void AtualizarEstadosInner()
        {
        ...
        public void RetornarEstadoInners(Enumeradores.EstadosInner estadosInner, Enumeradores.EstadosTeclado EstadoTeclado)
        {
            foreach (Inner inner in ListInners.Values)
            {
        ...
        public string acionaDoisLadosDaCatraca()
        {
            ...
            try
            {
                EasyInner.EnviarMensagemPadraoOnLine(1, 0, "Acesso Liberado!");
                EasyInner.ConfigurarLeitor2((byte)Enumeradores.Operacao.ENTRADA_E_SAIDA);
                return "Liberada com sucesso para dois lados!";
            }
            catch (Exception err)
            {
        ...
        public bool LiberarAcesso(string NumCartao)
        {
            bool acesso = false;
        ...
        //***********************************************************************************
        public void DefineValoresParaConfigurarLeitores(Inner innerAtual)
        {
        ...
        public void MontaConfiguracaoInner(Inner innerAtual, Enumeradores.modoComunicacao modo)
        {
        ...
        public static void ConfigurarTpLeitor(Inner innerAtual)
        {
        ...
        public int BinarioParaDecimal(string valorBinario)
        {
            int expoente = 0;
            int numero;
            int soma = 0;
        ...
        /// <param name="InnerAtual"></param>
        /// <returns></returns>
        public int ConfiguraEntradasMudancaOnLine(Inner InnerAtual)
        {
            string Configuracao;
        ...
        /// </summary>
        /// <param name="InnerAtual"></param>
        public void MontarHorarios(Inner InnerAtual)
        {
        ...
        //***********************************************************************************
        public void MontarListaTopdata(Inner InnerAtual)
        {
        ...
        //***********************************************************************************
        public void MontarListaLivre(Inner InnerAtual, List<Usuarios> Lista)
        {
            //Define qual padrao o Inner vai usar
        ...
        //***********************************************************************************
        public void MontarBufferListaSemDigital(Inner InnerAtual, List<UsuarioSemDigital> ListaSD)
        {
        ...
        /// <param name="InnerAtual"></param>
        /// <returns></returns>
        public int testaConexaoInner(Inner InnerAtual)
        {
            int RetRelogio = -1;
            byte Dia = 0;
            byte Mes = 0;
        ...
        /// <param name="InnerAtual"></param>
        public void ColetarBilhetesInnerAcesso(Inner InnerAtual)
        {
            try
            {
        ...
        /// <param name="UiMainOnline"></param>
        /// <param name="InnerAtual"></param>
        public void ColetarBilhetesInnerNet(Inner InnerAtual)
        {
            try
            {
        ...
        public void MontarBilheteRecebido(Inner InnerAtual)
        {
        ...
        public string MontarCartao(string Cartao, int tam)
        {
            string strCartao = "";
        ...
        public string MontarCartaoBio(string Cartao)
        {
            string strCartao = "";
        ...
        public int ReceberModeloBio6xx(Inner InnerAtual)
        {
            int Ret = -1;
        ...
        public int ReceberModeloBioAVer5(Inner InnerAtual)
        {
            int Ret = -1;
            int Modelo = 0;
        ...
        public int ReceberVersaoBioAVer5(Inner InnerAtual)
        {
            int Ret = -1;
            int VersaoAltaBio = 0;
        ...
        public int ReceberVersaoBio6xx(Inner InnerAtual)
        {
            int Ret = -1;
        ...
        public void MaquinaOnline()
        {
            try
            {
                ...
                if (Ret2 == (int)Enumeradores.Retorno.RET_COMANDO_OK)
                {
                    ...
                    TcpListener listener = new TcpListener(ipAddress, 9000);
                    listener.Start();
                        ...
                        foreach (Inner InnerAtual in ListInners.Values)
                        {
                            ...
                            switch (InnerAtual.EstadoAtual)
                            {
                                ...
                                case Enumeradores.EstadosInner.ESTADO_POLLING:
                                  ...
                                  //  LiberarCatracaDoisSentidos(1);
                                    //FrmOnline formi = new FrmOnline(this);
                                    //Application.Exit();
                                   // parapara = true;
                                    break;
              ...
              //  MessageBox.Show(LiberarCatracaDoisSentidos(1).ToString());
                EasyInner.FecharPortaComunicacao();
            }
            catch (Exception ex)
            {
        ...
        public void PASSO_ESTADO_DESLIGA_RELE(Inner InnerAtual)
        {
        ...
        public void PASSO_ESTADO_VALIDA_URNA_CHEIA(Inner InnerAtual)
        {
        ...
        public void PASSO_ESTADO_ENVIAR_MSG_URNA_CHEIA(Inner InnerAtual)
        {
            int ret = -1;
        ...
        /// <param name="UiMainOnline"></param>
        /// <param name="InnerAtual"></param>
        public void PASSO_ESTADO_CONECTAR(Inner InnerAtual)
        {
            int count = 0;
            int Ret = -1;
            try
        ...
        /// <param name="UiMainOnline"></param>
        /// <param name="InnerAtual"></param>
        public void PASSO_ESTADO_ENVIAR_CONFIGMUD_ONLINE_OFFLINE(Inner InnerAtual)
        {
            int Ret = -1;
            try
            {
        ...
        /// </summary>
        /// <param name="InnerAtual"></param>
        public void PASSO_ESTADO_ENVIAR_MSG_OFF_CATRACA(Inner InnerAtual)
        {
            int Ret = -1;
            try
            {
        ...
        /// <param name="UiMainOnline"></param>
        /// <param name="InnerAtual"></param>
        public void PASSO_ESTADO_ENVIAR_CFG_OFFLINE(Inner InnerAtual)
        {
            int ret = 0;
            try
            {
        ...
        public void PASSO_ESTADO_ENVIAR_LISTA_SEMDIGITAL(Inner InnerAtual)
        {
            try
            {
                int ret = 0;
        ...
        public void PASSO_ESTADO_ENVIAR_LISTA_OFFLINE(Inner InnerAtual)
        {
            int Ret = 0;
        ...
        /// </summary>
        /// <param name="innerAtual"></param>
        public void PASSO_ESTADO_AGUARDA_TEMPO_MENSAGEM(Inner innerAtual)
        {
            try
            {
        ...
        /// <param name="UiMainOnline"></param>
        /// <param name="InnerAtual"></param>
        public void PASSO_ESTADO_COLETAR_BILHETES(Inner InnerAtual)
        {
            if (InnerAtual.InnerNetAcesso)
            {
        ...
        /// <param name="UiMainOnline"></param>
        /// <param name="InnerAtual"></param>
        public void PASSO_ESTADO_ENVIAR_CFG_ONLINE(Inner InnerAtual)
        {
            try
            {
                Thread.BeginCriticalRegion();
        ...
        /// <param name="UiMainOnline"></param>
        /// <param name="InnerAtual"></param>
        public void PASSO_ESTADO_ENVIAR_DATA_HORA(Inner InnerAtual)
        {
            try
            {
                //Declaração de Variáveis..
        ...
        /// <param name="UiMainOnline"></param>
        /// <param name="InnerAtual"></param>
        public void PASSO_ESTADO_CONFIGURAR_ENTRADAS_ONLINE(Inner InnerAtual)
        {
            try
            {
                //Declaração de variáveis..
        ...
        /// <param name="UiMainOnline"></param>
        /// <param name="InnerAtual"></param>
        public void PASSO_ESTADO_DEFINICAO_TECLADO(Inner InnerAtual)
        {
            int Ret = -1;
        ...
        /// <param name="UiMainOnline"></param>
        /// <param name="InnerAtual"></param>
        public void PASSO_ESTADO_AGUARDA_DEFINICAO_TECLADO(Inner InnerAtual)
        {
            byte Origem = 0;
            byte Complemento = 0;
            StringBuilder Cartao = new StringBuilder();
        ...
        /// <param name="UiMainOnline"></param>
        /// <param name="InnerAtual"></param>
        public void PASSO_ESTADO_POLLING(Inner InnerAtual)
        {
            try
            {
                //Declaração de Variáveis..
        ...
        /// </summary>
        /// <param name="innerAtual"></param>
        public void PASSO_ESTADO_ENVIAR_MSG_PADRAO(Inner innerAtual)
        {
            try
            {
        ...
        /// <param name="UiMainOnline"></param>
        /// <param name="InnerAtual"></param>
        public void PASSO_ESTADO_ENVIAR_MSG_ACESSO_NEGADO(Inner InnerAtual)
        {
            int ret = -1;
        ...
        /// </summary>
        /// <param name="innerAtual"></param>
        public void PASSO_ESTADO_ENVIAR_MSG_URNA(Inner innerAtual)
        {
            try
            {
        ...
        /// <param name="UiMainOnline"></param>
        /// <param name="InnerAtual"></param>
        public void PASSO_ESTADO_LIBERA_GIRO_CATRACA(Inner InnerAtual)
        {
            try
            {
                //Declaração de Variáveis..
        ...
        /// <param name="UiMainOnline"></param>
        /// <param name="InnerAtual"></param>
        public void PASSO_ESTADO_MONITORA_GIRO_CATRACA(Inner InnerAtual)
        {
            try
            {
                //Declaração de Variáveis..
        ...
        /// <param name="UiMainOnline"></param>
        /// <param name="InnerAtual"></param>
        public void PASSO_ESTADO_MONITORA_URNA(Inner InnerAtual)
        {
            try
            {
                //Declaração de Variáveis..
        ...
        /// <param name="UiMainOnline"></param>
        /// <param name="InnerAtual"></param>
        public void PASSO_ESTADO_ENVIAR_PING_ONLINE(Inner InnerAtual)
        {
            try
            {
        ...
        /// <param name="UiMainOnline"></param>
        /// <param name="InnerAtual"></param>
        public void PASSO_ESTADO_RECONECTAR(Inner InnerAtual)
        {
            try
            {
                int count = 0;
        ...
        public void PASSO_ESTADO_RECEBER_QTD_BILHETES_OFF(Inner InnerAtual)
        {
            int Ret = -1;
            int[] receber = new int[2];
        ...
        public void PASSO_ESTADO_VALIDAR_ACESSO(Inner InnerAtual)
        {
        ...
        public void PASSO_ESTADO_RECEBER_FIRMWARE(Inner InnerAtual)
        {
            byte Linha = 0;
            short Variacao = 0;
            byte VersaoBaixa = 0;
        ...
        public void PASSO_ESTADO_RECEBER_MODELO_BIO(Inner InnerAtual)
        {
            int Ret = -1;
        ...
        public void PASSO_ESTADO_RECEBER_VERSAO_BIO(Inner InnerAtual)
        {
            int Ret = -1;
            if (InnerAtual.VersaoFW < 6)
            {
        ...
        public void PASSO_ESTADO_ENVIAR_MSG_OFF_COLETOR(Inner InnerAtual)
        {
            int Ret = 0;
        ...
        public void PASSO_ESTADO_ACIONAR_RELE1(Inner InnerAtual)
        {
            //Aciona Bip Curto..
            EasyInner.AcionarBipCurto(InnerAtual.Numero);
            //Desliga Led Verde
        ...
        public void PASSO_ESTADO_ACIONAR_RELE2(Inner InnerAtual)
        {
            //Aciona Bip Curto..
            EasyInner.AcionarBipCurto(InnerAtual.Numero);
            //Desliga Led Verde
