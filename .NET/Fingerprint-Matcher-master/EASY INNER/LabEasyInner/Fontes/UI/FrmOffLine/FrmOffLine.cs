...
namespace EasyInnerSDK.UI
{
    public partial class FrmOffLine : Form
    {
        ...
        private void FrmOffLine_Load(object sender, EventArgs e)
        {
            ...
            this.cboTipoLeitor.Items.Add("Barras, Prox, QR Code com letras");
            this.cboTipoLeitor.SelectedIndex = 2;
        ...
        private void cboPadraoCartao_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cboTipoLeitor.SelectedIndex == 3)
            {
                txtDigitos.Text = "6";
            }
        ...
        private void txtNumInner_KeyPress(object sender, KeyPressEventArgs e)
        {  // Somente números no txtBox do número do Inner
