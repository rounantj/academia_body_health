...
namespace EasyInnerSDK.UI
{
    public class FrmOffLineController
    {
        ...
        private void ConfigurarBio()
        {
            ...
            if ((Linha == 6 || (Linha == 14) || (Linha == 18)) && (UiOffline.chkBio.Checked))
            {
                if (VersaoAlta < 6)
                {
        ...
        private int ReceberModeloBio6xx()
        {
            ...
            if (Ret == (int)Enumeradores.Retorno.RET_COMANDO_OK)
            {
                ...
                if (Ret == (int)Enumeradores.Retorno.RET_COMANDO_OK)
                {
                    UiOffline.lblVersao.Text += "\r\nModelo Bio\t" + Encoding.ASCII.GetString(ModeloBio);
                }
            }
            return Ret;
        }
        ...
        private bool DefineVersao()
        {
            ...
            while(Ret2 != 0)
            {
                ...
                //Ret2 = EasyInner.ReceberVersaoFirmware6xx_ComComplementar(int.Parse(UiOffline.txtNumInner.Text), ref Linha_, ref VariacaoInner, ref VersaoAlta,
                //                                        ref VersaoBaixa, ref VersaoSufixo, ref InnerAcessoBio, ref TipoModBio, ref ComplementarVersaoSuperior, ref ComplementarVersaoInferior, ref TipoDeOperacao);
            ...
            if (Ret2 == (int)Enumeradores.Retorno.RET_COMANDO_OK)
            {
                ...
                UiOffline.lblVersao.Text = LinhaInner.ToString() + "\t" + VersaoAlta.ToString() + "." + VersaoBaixa.ToString() + "\r\n";
                return true;
            } 
            else 
            {
        ...
        private void MontarConfiguracao(FrmOffLine UiMainOffline)
        {
            ...
            // Se for da linha 18 (Inner Acesso 2) e tentar configurar como catraca gera a mensagem.
            if ((Linha == 18) && (UiMainOffline.cboEquipamento.SelectedIndex != (int)Enumeradores.Acionamento.Acionamento_Coletor))
            {
                MessageBox.Show("Este Inner não deve ser configurado como catraca!", "Configuração Incorreta!");
            }
        ...
        private void ColetarBilhetesInnerAcesso(FrmOffLine UiMainOffline)
        {
            ...
            int[] receber = new int[2];
                ...
                UiMainOffline.lblBilhetes.Text = nBilhetes != 0 ? ("Foram coletados " + nBilhetes + " bilhete(s) offline!") : "Não há bilhetes a serem coletados!";               
