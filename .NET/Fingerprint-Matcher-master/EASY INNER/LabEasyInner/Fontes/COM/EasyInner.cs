...
namespace EasyInnerSDK
{
    ...
    class EasyInner
    {
        ...
        #region InserirDigitosVariaveis
        //Para usar cartões de digitos variáveis
        [DllImport("EasyInner.dll", CallingConvention = CallingConvention.Winapi)]
        ...
        //recebe a quantidade de bilhetes que há no Inner. Esse comando é somente para Inner Acesso.
        [DllImport("EasyInner.dll", CallingConvention = CallingConvention.Winapi)]
        public static extern byte ReceberQuantidadeBilhetes(int Inner, int[] QtdeBilhetes);
        #endregion
        ...
        #region IncluirUsuarioSemDigitalBioInnerAcesso
        /// <summary>
        ...
        /// <returns></returns>
        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte IncluirUsuarioSemDigitalBioInnerAcesso(string Cartao);
        #endregion

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte EnviarListaUsuariosSemDigitalBioVariavel(int Inner, int QtdDigitosSD);
        ...
        #region EnviarListaUsuariosSemDigitalBioInnerAcesso
        /// <summary>
        /// Envia o buffer com a lista de usuários sem digital para o Inner. Após a execução do
        ///comando, o buffer é limpo pela dll.
        /// </summary>
        ...
        /// <returns></returns>
        [DllImport("EasyInner.dll", CallingConvention = CallingConvention.Winapi)]
        public static extern byte EnviarListaUsuariosSemDigitalBioInnerAcesso(int Inner);
        #endregion
        ...
        #region SetarBioVariavel
        /// <summary>
        /// define para a EasyInner que o usuario a manipulado será para versão acima de 5xx.
        /// </summary>
        /// <param name="Light">1 – É um Inner bio light
        ///0 – versões abaixo 5xx, 1 versões acima 5xx</param>
        [DllImport("EasyInner.dll", CallingConvention = CallingConvention.Winapi)]
        public static extern void SetarBioVariavel(int Maior);
        #endregion

        #region SolicitarDigitalUsuario novo formato template
        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte SolicitarDigitalUsuario(int Inner, string Usuario);
        #endregion

        #region ReceberDigitalUsuario novo formato template
        [DllImport("EasyInner.dll", CallingConvention = CallingConvention.Winapi)]
        public static extern byte ReceberDigitalUsuario(int Inner, byte OnLine, byte[] Digital);
        #endregion
        ...
        [DllImport("EasyInner.dll", CallingConvention = CallingConvention.Winapi)]
        public static extern byte ConfigurarTimeoutIdentificacao(byte TimeoutIdentificacao);
        
        [DllImport("EasyInner.dll", CallingConvention = CallingConvention.Winapi)]
        public static extern byte ConfigurarNivelLFD(byte NivelLFD);
        ...
        /// <returns></returns>
        [DllImport("EasyInner.dll", CallingConvention = CallingConvention.Winapi)]
        public static extern byte SolicitarListaUsuariosBioVariavel(int Inner);
        #endregion
        ...
        #region EnviarDigitalUsuario
        [DllImport("EasyInner.dll", CallingConvention = CallingConvention.Winapi)]
        public static extern byte EnviarDigitalUsuario(int Inner, string Usuario, byte[] Digital1, byte[] Digital2);
        #endregion

        #region SolicitarListaUsuariosComDigital novo formato bio
        [DllImport("EasyInner.dll", CallingConvention = CallingConvention.Winapi)]
        public static extern byte SolicitarListaUsuariosComDigital(int Inner);
        #endregion

        #region ReceberUsuarioComDigital novo formato bio
        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte ReceberUsuarioComDigital(byte[] Usuario);
        #endregion
        
        #region ReceberDigitalUsuario novo formato template
        [DllImport("EasyInner.dll", CallingConvention = CallingConvention.Winapi)]
        public static extern byte ReceberDigitalUsuario(int Inner, byte[] Digital, int TamResposta);
        #endregion

        #region ConfigurarBioVariavel
        /// <summary>
        /// Define que o Inner utilizado no momento é um Inner bio light ao invés de um Inner bio
        ///1000/4000. Essa função deverá ser chamada sempre que necessário antes das funções
        ///SolicitarUsuarioCadastradoBio, SolicitarExclusaoUsuario, InserirUsuarioLeitorBio e
        ...
        ///0 – É um Inner bio 1000/4000(valor default)</param>
        [DllImport("EasyInner.dll", CallingConvention = CallingConvention.Winapi)]
        public static extern void ConfigurarBioVariavel(int Maior);
        #endregion

        #region ReceberRespostaRequisicaoBio
        [DllImport("EasyInner.dll", CallingConvention = CallingConvention.Winapi)]
        public static extern byte ReceberRespostaRequisicaoBio(int Inner, ref int TamResposta);
        #endregion
        ...
        [DllImport("EasyInner.dll", CallingConvention = CallingConvention.Winapi)]
        public static extern byte EnviarBufferEventosMudancaAuto(int NumInner);

        ///Novos comandos versão 6xx 4.0.0
        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte ReceberConfiguracoesInner(int Inner, byte[] ConfiguracoesInner);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RequisitarQuantidadeUsuariosBio(int Inner, int TipoComBio);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RespostaQuantidadeUsuariosBio(int Inner, ref int QtdUsuariosBio);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RequisitarListarUsuariosBio(int Inner, int TipoComBio, int NumPacote);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RespostaListarUsuariosBio(int Inner, ref int QtdPacotes, ref int Tamanho);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte ReceberListaPacUsuariosBio(int Inner, byte[] ListaUsuarios, int TamanhoBuffer);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte EnviarDigitalUsuarioBio(int Inner, int TipoModBio, string Usuario, byte[] Digital1, byte[] Digital2);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RespostaEnviarDigitalUsuarioBio(int Inner);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RequisitarModeloBio(int Inner, int TipoComBio);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RespostaModeloBio(int Inner, byte[] ModeloBio);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RequisitarVersaoBio(int Inner, int TipoComBio);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RespostaVersaoBio(int Inner, byte[] VersaoBio);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RequisitarExcluirUsuarioBio(int Inner, int TipoComBio, string Usuario);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RespostaExcluirUsuarioBio(int Inner);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RequisitarExcluirTodosUsuariosBio(int Inner, int TipoComBio);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RespostaExcluirTodosUsuariosBio(int Inner);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RequisitarUsuarioCadastradoBio(int Inner, int TipoModBio, string Usuario);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RespostaUsuarioCadastradoBio(int Inner, ref int TamanhoReceber);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte ReceberDigitalUsuarioBio(int Inner, byte[] BufferTemplate, int TamanhoReceber);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RequisitarEnviarAjustesBio(int Inner, int TipoModBio, byte[] AjustesBio);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RespostaEnviarAjustesBio(int Inner);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RequisitarVerificarDigitalBio(int Inner, int TipoModBio, string Usuario);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RespostaVerificarDigitalBio(int Inner);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RequisitarIdentificarUsuarioLeitorBio(int Inner, int TipoModBio);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RespostaIdentificarUsuarioLeitorBio(int Inner, byte[] UsuarioIdentificado);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RequisitarReceberTemplateLeitorInnerBio(int Inner, int TipoModBio);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RespostaReceberTemplateLeitorInnerBio(int Inner, ref int Tamanho);  

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte ReceberTemplateLeitorInnerBio(int Inner, byte[] TemplateRecebido, int Tamanho);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RequisitarVerificarCadastroUsuarioBio(int Inner, int TipoModBio, string Usuario);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RespostaVerificarCadastroUsuarioBio(int Inner);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RequisitarHabilitarIdentificacaoVerificacao(int Inner, int TipoModBio, int Identificacao, int Verificacao);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte RespostaHabilitarIdentificacaoVerificacao(int Inner);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte ReceberDadosOnLine_QRCodeComLetras(int Inner, ref byte Origem, ref byte Complemento, StringBuilder Cartao, ref byte Dia, ref byte Mes, ref byte Ano, ref byte Hora, ref byte Minuto, ref byte Segundo);

        //4.0.8

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte ReceberVersaoFirmware6xx(int Inner, ref byte Linha, ref short Variacao, ref byte VersaoAlta, ref byte VersaoBaixa, ref byte VersaoSufixo, ref byte InnerAcessoBio, ref byte TipoModBio);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte ReceberVersaoFirmware6xx_ComComplementar(int Inner, ref byte Linha, ref short Variacao, ref byte VersaoAlta, ref byte VersaoBaixa, ref byte VersaoSufixo, ref byte InnerAcessoBio, ref byte TipoModBio, ref byte ComplementarVersaoSuperior, ref byte ComplementarVersaoInferior, ref byte TipoDeOperacao);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte DesabilitarWebServer(byte Desabilita);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte DefinirSensorPortaOffline(byte Logica);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte DesabilitarBipColetor(byte Desabilita);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte ConfigurarBotaoExternoOffline(byte Funcao);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte EnviarSinalizacao(int Inner, byte TipoSinalizacao, byte ModoSinalizacao, byte Terminal);

        [DllImport("EasyInner.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        public static extern byte ReceberDadosOnLine_ComLetras(int Inner, ref byte Origem, ref byte Complemento, StringBuilder Cartao, ref byte Dia, ref byte Mes, ref byte Ano, ref byte Hora, ref byte Minuto, ref byte Segundo);
